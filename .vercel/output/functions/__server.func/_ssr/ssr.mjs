...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cjk6rrlV.mjs");
...
var manifest = {
	"12b681ffbea9aa622dfcacba3358a817542f13f80519bfa1a34dadf7a7d38fd9": {
		functionName: "transcribeAudio_createServerFn_handler",
		importer: () => import("./server-DxKqlwIK.mjs")
	},
	"216f2226b1f738d40da13d599db89bccd408481fd517bb51a607df67c9bc6741": {
		functionName: "chatTurn_createServerFn_handler",
		importer: () => import("./server-DxKqlwIK.mjs")
	},
	"aa2df86d59c856e3193500da12a2a77734eec024e490a553dd3140a408c8a52f": {
		functionName: "speakText_createServerFn_handler",
		importer: () => import("./server-DxKqlwIK.mjs")
	},
	"ba9a85fe51c5474412ce86cb991ef1389dfaa169108a59be7aa48c911a535f3a": {
		functionName: "createVoiceSession_createServerFn_handler",
		importer: () => import("./server-DxKqlwIK.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CXi0_VUg.mjs").then((n) => n.t),
